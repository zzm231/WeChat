...
import com.swu.zzm.wechat.model.UserCache;
...
//        mIsManager = UserCache.getAccount().equals(mTeam.getCreator());
    ...
    public void initView() {
        setContentView(R.layout.activity_team_creat_info);
...
//        }
    ...
    private void setAdapter() {
        if (mAdapter == null) {
            mAdapter = new LQRAdapterForRecyclerView(this, mTeamMemberList,R.layout.item_member_info_group_cheat_rv ) {
                @Override
