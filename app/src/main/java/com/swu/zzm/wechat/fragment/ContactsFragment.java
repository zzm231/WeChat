...
import com.swu.zzm.wechat.activity.AllTagActivity;
...
import com.swu.zzm.wechat.nimsdk.utils.NimRecentContactSDK;
...
public class ContactsFragment extends BaseFragment {
    ...
    public void initListener() {
        ...
        mLlTag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().startActivity(new Intent(getActivity(), AllTagActivity.class));
            }
        });
