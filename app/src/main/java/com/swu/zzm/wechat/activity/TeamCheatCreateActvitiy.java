...
import com.swu.zzm.wechat.utils.SortUtils;
import com.swu.zzm.wechat.utils.StringUtils;
import com.swu.zzm.wechat.utils.UIUtils;
import com.swu.zzm.wechat.view.QuickIndexBar;
...
import static com.swu.zzm.wechat.R.id.ivHeader;
...
//                fields.put(TeamFieldEnum.Name, "群聊(" + accounts.size() + 1 + ")");
    ...
    public void initView() {
        setContentView(R.layout.activity_team_cheat_creat);
    ...
    private void setContactsAdapter() {
        mAdapter = new LQRAdapterForRecyclerView<Contact>(this, mContacts,R.layout.item_contact_cv) {
            @Override
    ...
    private void setSelectedContactsAdapter() {
        ...
        if (mSelectedContactsAdapter == null) {
            mSelectedContactsAdapter = new LQRAdapterForRecyclerView<Contact>(this, mSelectedContacts, R.layout.item_selected_contact_rv) {
                @Override
